...
import classes from "./ShowDetailToolbar.module.css";
...
export function ShowDetailToolbar({
  refreshing,
  searching,
  deleting,
  hasFiles = false,
  ...
  return (
    <div className={classes.bar} role="toolbar" aria-label="Show actions">
      <div className={classes.group}>
        ...
        <ToolbarAction
          ...
          disabled={!hasFiles}
          title={hasFiles ? undefined : "No episode files to rename"}
        ...
        <ToolbarAction
          ...
          disabled={!hasFiles}
          title={hasFiles ? undefined : "No episode files to manage"}
