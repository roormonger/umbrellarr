...
import { getArtistHistory } from "@/api/artists";
import { ArtistHistoryDetailsModal } from "@/components/artists/ArtistHistoryDetailsModal";
...
function HistoryRow({
  ...
  event: ArtistHistoryEvent;
  onDetails: (event: ArtistHistoryEvent) => void;
}) {
...
export function ArtistHistoryModal({ opened, onClose, instanceId, artistId }: Props) {
  const [detailsEvent, setDetailsEvent] = useState<ArtistHistoryEvent | null>(null);
            ...
            <Table striped highlightOnHover withTableBorder>
              ...
              <Table.Tbody>
                {historyQuery.data.events.map((event) => (
                  <HistoryRow key={event.id} event={event} onDetails={setDetailsEvent} />
                ))}
              </Table.Tbody>
            </Table>
          </ScrollArea.Autosize>
